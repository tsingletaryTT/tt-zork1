...
echo "interpret(20+ instructions) hangs when PRINT fires — a firmware-level limit"
echo "on QB2 that only the TT-Metal team can address."
echo ""
echo "This is proof-of-concept, not a playable game. The hybrid and ai demos are."
echo "─────────────────────────────────────────────────────────────────"
sleep 4
